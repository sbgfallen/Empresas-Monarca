...
import { formatCurrency, getImageUrl, parseNumeric, buildWhatsAppUrl } from "../lib/utils";
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:gap-3">
                    ...
                    <a
                      href={buildWhatsAppUrl({ title: product.title || "Producto", price: parseNumeric(product.price), downPayment: parseNumeric(product.down_payment), months: getSelectedMonths(product.id), whatsappNumber })}
                      target="_blank"
